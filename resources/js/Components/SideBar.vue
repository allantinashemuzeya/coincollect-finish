...
//current route
const current_route = computed(() => page.props.current_route)
        ...
        <nav id="sidebar">
            ...
            <div class="navbar-nav theme-brand flex-row  text-center">
                <div class="nav-logo">
                    ...
                    <div class="nav-item theme-text">
                        <a href="index-2.html" class="nav-link"> CoinCollect</a>
                    </div>
                </div>
            ...
            <div class="profile-info">
                <div class="user-info">
                    ...
                    <div class="profile-content" style="margin-left: 1rem;">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                <li class="menu" :class="current_route === 'dashboard' ? 'active' : ''">
                    <Link :href="route('dashboard')" aria-expanded="true" class="dropdown-toggle" >
                        <div class="">
                ...
                <li class="menu" :class="current_route === 'market-place' ? 'active' : ''">
                    <Link href="/market-place" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
